...
describe('useThreads', () => {
  describe('load', () => {
    it('fetches and stores threads', async () => {
      const data = [
        { id: '1', title: 'Thread 1', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''},
        { id: '2', title: 'Thread 2', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''},
      ];
  ...
  describe('addOrUpdate', () => {
    it('prepends a new thread', () => {
      ...
      threads.value = [
        { id: '1', title: 'Existing', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''},
      ];

      addOrUpdate({ id: '2', title: 'New', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''});
    ...
    it('updates an existing thread in place', () => {
      const { threads, addOrUpdate } = useThreads();
      threads.value = [
        { id: '1', title: 'Old Title', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''},
      ];

      addOrUpdate({ id: '1', title: 'New Title', source: 'web', job_run_id: null, archived_at: null, created_at: '', updated_at: ''});
