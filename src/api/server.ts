...
export function buildServer({ logger, db, agentService, threadService, memoryService, eventBus, jobService, systemService }: ServerDeps) {
  ...
  app.register(systemRoute, { prefix: '/v1', systemService });
