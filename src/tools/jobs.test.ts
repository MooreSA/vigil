...
const userProfileService = mockUserProfileService();
...
describe('list_jobs tool', () => {
  it('returns message when no jobs exist', async () => {
    ...
    const tool = createListJobsTool(service, userProfileService, logger);
...
describe('create_job tool', () => {
  it('creates a job and returns confirmation', async () => {
    ...
    const tool = createCreateJobTool(service, userProfileService, logger);
...
describe('update_job tool', () => {
  it('updates a job and returns confirmation', async () => {
    ...
    const tool = createUpdateJobTool(service, userProfileService, logger);
